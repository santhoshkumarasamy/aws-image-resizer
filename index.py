...
bucket_1 = os.environ.get("BUCKET_1") # your-source-bucket
bucket_2 = os.environ.get("BUCKET_2") # your-destination-bucket
sns_topic_arn = os.environ.get("SNS_TOPIC_ARN") # your-sns-topic
